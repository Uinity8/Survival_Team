...
namespace _01_Scripts.Enemy.Enemies
{
    ...
    public class EnemyManager : MonoBehaviour
    {
        ...
        {
            var possibleEnemies = enemiesInRange.Where(e => e.MeleeFighter.Target != null && e.IsInState(EnemyStates.CombatMovement) && e.DistanceToTarget <= e.MeleeFighter.MaxAttackRange 
                && e.LineOfSightCheck(e.MeleeFighter.Target) && !e.MeleeFighter.Target.IsInSyncedAnimation).ToList();
