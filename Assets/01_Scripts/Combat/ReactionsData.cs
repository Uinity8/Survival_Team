...
namespace _01_Scripts.Combat
{
    ...
    public class ReactionContainer
    {
        ...
        [Tooltip("Direction of the hit")] [HideInInspectorEnum(1)]
        ...
        [Tooltip(
            "You can specify tags like Powerful or Weak for reactions and play them based on the tag provied in the attack")]
        public string tag;
    ...
    {
        [Tooltip("The animation clip associated with this reaction.")] [HideInInspector]
    ...
    public enum KnockDownDirection
    {
        LyingOnBack,
        LyingOnFront
    }
