...
namespace _01_Scripts.Combat.Editor
{
    public class AnimationPreviewHandler : UnityEditor.Editor
    {
        ...
        protected static UnityEditor.Editor editor;
        ...
        void SampleAnimationPreview(Rect r)
        {
            ...
            if (editor == null)
                editor = UnityEditor.Editor.CreateEditor(previewObject);
