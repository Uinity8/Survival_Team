    ...
    public class HideInInspectorEnumDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.propertyType == SerializedPropertyType.Enum)
            {
                ...
                // Display the popup
                int selectedIndex = global::System.Array.IndexOf(visibleNames.ToArray(), enumNames[enumValueIndex]);
                if (selectedIndex < 0) selectedIndex = 0;

                selectedIndex = EditorGUI.Popup(position, label.text, selectedIndex, visibleNames.ToArray());
                property.enumValueIndex = global::System.Array.IndexOf(enumNames, visibleNames[selectedIndex]);
